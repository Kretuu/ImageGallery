...
ActiveRecord::Schema[7.1].define(version: 2024_04_11_174503) do
  ...
  create_table "photo_galleries", force: :cascade do |t|
    ...
    t.index ["thumbnail_id"], name: "index_photo_galleries_on_thumbnail_id"
  ...
  add_foreign_key "photo_galleries", "photos", column: "thumbnail_id"
